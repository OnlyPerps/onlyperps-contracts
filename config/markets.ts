...
const config: {
  ...
  seiTestnet: [
    ...
    {
      tokens: { indexToken: "WSEI", longToken: "WSEI", shortToken: "USDT" },
      virtualTokenIdForIndexToken: hashString("PERP:WSEI/USD"),
      virtualMarketId: hashString("SPOT:WSEI/USD"),
    ...
    {
      tokens: { indexToken: "WSEI", longToken: "USDT", shortToken: "USDT" },
      virtualTokenIdForIndexToken: hashString("PERP:WSEI/USD"),
      virtualMarketId: hashString("SPOT:WSEI/USD"),
    ...
    {
      tokens: { indexToken: "WLD", longToken: "USDT", shortToken: "USDT" },
      virtualTokenIdForIndexToken: hashString("PERP:WLD/USD"),
      virtualMarketId: hashString("SPOT:WLD/USD"),

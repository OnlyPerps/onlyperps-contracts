...
const config: {
  ...
  seiTestnet: {
    WBTC: {
      transferGasLimit: 200 * 1000,
      deploy: false,
      address: "0x91F077956442b544b81c7cd24232D4F616A6fB6D",
      decimals: 8,
    },
    WETH: {
      transferGasLimit: 200 * 1000,
      deploy: false,
      address: "0x015fB54ab5F94F4194C2c61F20c1FCf6066400a9",
      decimals: 18,
    },
    WSEI: {
      transferGasLimit: 200 * 1000,
      deploy: false,
      address: "0xB988AE9bF6a4ebE92f9FF391cAE1eA09484284E5",
      decimals: 18,
      wrappedNative: true,
    },
    USDT: {
      transferGasLimit: 200 * 1000,
      deploy: false,
      address: "0x88ae85C78791ac69e4071E7910B23c87e1F9a587",
      decimals: 6,
    },
    USDC: {
      transferGasLimit: 200 * 1000,
